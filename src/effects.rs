...
use tachyonfx::fx::{
    coalesce, dissolve, fade_from, fade_to, never_complete, parallel, sequence, sleep, sweep_in,
    with_duration,
};
...
pub fn notification_effect() -> Effect {
    ...
    fx::sequence(&[
        ...
        fx::parallel(&[draw_border(Duration::from_millis(150)), fx::coalesce(150)]),
    ])
}
